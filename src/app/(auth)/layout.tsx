            ...
            <div className='w-full h-full flex '>
                <div className='hidden md:flex w-full h-full lg:w-2/5 flex-col justify-between px-5 py-10 rounded-3xl bg-[url("/images/purple-login.jpg")] bg-no-repeat bg-cover bg-center'>
                    <div className='flex items-center justify-between'>
                        ...
                        <Link href="/" className='flex items-center bg-white/20 px-5 py-2 rounded-full text-white/80 text-sm gap-x-2 hover:text-white hover:gap-x-3 transition hover:bg-white/30 cursor-pointer'>
                            <FaArrowLeft />
                            Back to home
                        </Link>
                    </div>
                    <h1 className='text-3xl text-medium text-white text-center'>
